...
if (([_playerX] call A3A_fnc_countAttachedObjects) < 0) exitWith {["Move HQ", "You have other things attached, you cannot move this."] call A3A_fnc_customHint;}; //TheNightBird edit fixing an annoying bug (might be due to mod mismatch)
